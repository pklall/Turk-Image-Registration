...
public abstract class RenderablePointSelector extends PointSelector implements
	...
	private PointRenderer hoverPointRenderer;

	// hold the currently hovered/selected point
	private final float[] curPointBuffer = new float[2];

	public RenderablePointSelector(float[] points, TextureData selectedTexture,
			TextureData hoverTexture, TextureData unselectedTexture,
		...
		unselectedPointRenderer = new PointRenderer(unselectedTexture, points);
	}
