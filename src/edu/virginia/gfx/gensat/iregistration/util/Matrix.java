...
public class Matrix {
	 ...
	 * multiplication works, the result matrix will have the same effect as
	 * first multiplying by the rhs matrix, then multiplying by the lhs matrix.
	 ...
	 *             result.length or lhsOffset + 16 > lhs.length or rhsOffset +
	 *             16 > rhs.length.
	 */
	public static void multiplyMM(float[] result, int resultOffset,
		...
		result[resultOffset + 15] = lhs[lhsOffset + 3] * rhs[rhsOffset + 12]
				...
				+ lhs[lhsOffset + 15] * rhs[rhsOffset + 15];
	}
	 ...
	 * 
	 * @throws IllegalArgumentException
	 *             if resultVec, lhsMat, or rhsVec are null, or if
